...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; font-family: 'DM Sans', sans-serif; }
        ...
        .card { background: var(--surface); border: 2px solid var(--border); border-radius: 20px; padding: 20px; display: flex; gap: 20px; align-items: center; }
        .card-img { width: 90px; height: 90px; border-radius: 16px; object-fit: cover; border: 2px solid var(--border); }
        .card-info { flex: 1; }
        .card-name { font-weight: 700; color: var(--cream); font-size: 18px; margin-bottom: 4px; }
        .card-cat { font-size: 12px; color: var(--text-dim); text-transform: uppercase; font-weight: 700; letter-spacing: 1px; margin-bottom: 6px; }
        .card-price { color: var(--gold); font-weight: 800; font-size: 18px; }
        
        .card-actions { display: flex; flex-direction: column; gap: 10px; }
        .btn-tool { background: var(--surface2); border: 2px solid var(--border); color: var(--text); padding: 10px; border-radius: 10px; cursor: pointer; font-size: 20px; }
            ...
            <?php foreach ($menus as $m): ?>
                <div class="card">
                    ...
                    <div class="card-info">
                        ...
                        <div class="card-name"><?= htmlspecialchars($m['nama']) ?></div>
